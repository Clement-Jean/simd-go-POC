...
void store(uint8_t* mem, __m128i in) {
  _mm_storeu_si128((__m128i*)mem, in);
}

__m128i set(uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e, uint8_t f, uint8_t g, uint8_t h, uint8_t i, uint8_t j, uint8_t k, uint8_t l, uint8_t m, uint8_t n, uint8_t o, uint8_t p) {
...
func MmStoreuSi128(m *Uint8, v M128I) { C.store(m, v) }
func MmSetrEpi8[T uint8 | int8](a [16]T) M128I {
	return C.set(
		(Uint8)(a[0]), (Uint8)(a[1]), (Uint8)(a[2]), (Uint8)(a[3]), (Uint8)(a[4]), (Uint8)(a[5]), (Uint8)(a[6]), (Uint8)(a[7]),
		(Uint8)(a[8]), (Uint8)(a[9]), (Uint8)(a[10]), (Uint8)(a[11]), (Uint8)(a[12]), (Uint8)(a[13]), (Uint8)(a[14]), (Uint8)(a[15]))
}

func MmAddEpi8(v0 M128I, v1 M128I) M128I { return C.add(v0, v1) }
