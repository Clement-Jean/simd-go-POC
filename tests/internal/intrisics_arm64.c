...
void VshlqnS8(int8x16_t* r, int8x16_t* v0, const int n) { *r = vshlq_n_s8(*v0, 4); }
void VshlqnU8(uint8x16_t* r, uint8x16_t* v0, const int n) { *r = vshlq_n_u8(*v0, 4); }
void VshrqnS8(int8x16_t* r, int8x16_t* v0, const int n) { *r = vshrq_n_s8(*v0, 4); }
void VshrqnU8(uint8x16_t* r, uint8x16_t* v0, const int n) { *r = vshrq_n_u8(*v0, 4); }
